...
-- Ensure the site_settings_public table has no RLS enabled (it should remain public)
-- This table contains only non-sensitive configuration data
ALTER TABLE public.site_settings_public DISABLE ROW LEVEL SECURITY;