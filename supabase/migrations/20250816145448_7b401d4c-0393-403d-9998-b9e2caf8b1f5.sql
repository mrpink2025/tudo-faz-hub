...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_affiliate_clicks_fraud_detection 
ON affiliate_clicks(visitor_ip, clicked_at, affiliate_link_id);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_affiliate_links_performance 
ON affiliate_links(affiliate_id, listing_id, tracking_code);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_affiliate_commissions_stats 
ON affiliate_commissions(affiliate_id, status, created_at);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_orders_affiliate_tracking 
