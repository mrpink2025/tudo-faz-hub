    ...
    <section className="relative overflow-hidden">
      <div className="container py-16 lg:py-24 grid gap-10 lg:grid-cols-2 items-center">
        <div className="space-y-6 relative z-10">
          <span className="inline-flex items-center rounded-full border px-3 py-1 text-xs text-muted-foreground">Seu marketplace local completo</span>
          ...
          <div className="flex items-center gap-3">
            <Link to="/publicar"><Button variant="hero" size="xl">Publicar anúncio</Button></Link>
            <Link to="/explorar"><Button variant="soft" size="xl">Explorar</Button></Link>
          </div>
        </div>
